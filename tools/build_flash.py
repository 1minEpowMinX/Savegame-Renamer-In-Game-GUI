...
# The game's own modal-window frame. The engine loads it from Libs/UI itself, so
# the texture is referenced rather than shipped. Ids continue after the fonts
# base.xml claims.
FRAME_IMAGES = [
